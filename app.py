...
.stTabs [data-baseweb="tab-list"]{position:relative;isolation:isolate;width:fit-content;max-width:100%;gap:5px;padding:7px;margin:0 0 3px;overflow-x:auto;border:1px solid rgba(255,255,255,.82);border-radius:999px;background:linear-gradient(135deg,rgba(255,255,255,.72),rgba(230,241,255,.46));box-shadow:inset 0 1px 0 rgba(255,255,255,.96),inset 0 -1px 0 rgba(133,162,195,.15),0 10px 30px rgba(42,73,114,.12),0 2px 7px rgba(42,73,114,.08);backdrop-filter:blur(24px) saturate(180%);-webkit-backdrop-filter:blur(24px) saturate(180%)}.stTabs [data-baseweb="tab-list"]:before{content:"";position:absolute;z-index:-1;inset:1px;border-radius:inherit;background:linear-gradient(115deg,rgba(255,255,255,.5),transparent 38%,rgba(108,177,255,.08) 72%,rgba(255,255,255,.38));pointer-events:none}.stTabs [data-baseweb="tab"]{position:relative;height:45px;border:1px solid transparent;border-radius:999px;padding:9px 21px;color:#30343b;font-family:-apple-system,BlinkMacSystemFont,'SF Pro Display','DM Sans',sans-serif;font-size:.9rem;font-weight:600;letter-spacing:-.01em;white-space:nowrap;transition:color .22s ease,background .22s ease,box-shadow .22s ease,transform .22s ease}.stTabs [data-baseweb="tab"]:hover{color:#0066cc;background:rgba(255,255,255,.56);border-color:rgba(255,255,255,.75);transform:translateY(-1px)}.stTabs [aria-selected="true"]{color:#fff!important;border-color:rgba(255,255,255,.5)!important;background:linear-gradient(145deg,rgba(53,161,255,.96),rgba(0,113,227,.98) 58%,rgba(0,91,199,.96))!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.52),inset 0 -1px 0 rgba(0,54,138,.28),0 7px 18px rgba(0,113,227,.3),0 1px 3px rgba(0,72,160,.22)!important;text-shadow:0 1px 1px rgba(0,50,120,.18);transform:translateY(-1px)}.stTabs [aria-selected="true"]:after{content:"";position:absolute;inset:2px 8px auto;height:42%;border-radius:999px;background:linear-gradient(180deg,rgba(255,255,255,.28),rgba(255,255,255,0));pointer-events:none}.stTabs [data-baseweb="tab-highlight"]{display:none}.stTabs [data-baseweb="tab-panel"]{animation:rise .36s ease-out}
